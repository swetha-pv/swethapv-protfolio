...
const Resume = () => {
  // Use Google Docs viewer for inline PDF viewing
  const resumeViewUrl = "https://docs.google.com/viewer?url=https://github.com/swetha-pv/imageProfile/raw/main/Swetha.pdf&embedded=true";
  // Use GitHub raw URL for downloading
  const resumeDownloadUrl = "https://github.com/swetha-pv/imageProfile/raw/main/Swetha.pdf";
